...
public class TeaVMBuilder {
    public static void main(String[] args) throws IOException {
        ...
        // teaBuildConfiguration.additionalAssetsClasspathFiles.add("in/mcxiv/app/asset.extension");

        // Register any classes or packages that require reflection here:
        // TeaReflectionSupplier.addReflectionClass("in.mcxiv.app.reflect");
